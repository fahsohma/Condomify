...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../node_modules/vanilla-masker/lib/vanilla-masker.js":[function(require,module,exports) {
var define;
...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // src/index.js
// Função para aplicar a máscara ao telefone
function aplicarMascaraTelefone(input) {
  (0, _vanillaMasker.default)(input).maskPattern('(99) 99999-9999');
}

// Função para formatar o nome, exceto palavras específicas
function formatarNome(nome) {
  var palavrasIgnoradas = ['de', 'da', 'do', 'dos', 'das', 'di'];
...
document.addEventListener('DOMContentLoaded', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var response, condominios, selectCondominio, telefoneInputInicial, nomeInputInicial;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        _context.next = 2;
        return fetch('/api/apartamentos/condominios');
      case 2:
        response = _context.sent;
        _context.next = 5;
        return response.json();
      case 5:
        condominios = _context.sent;
        selectCondominio = document.getElementById('nomeCondominio');
        ...
        telefoneInputInicial = document.querySelector('input[name="moradorTelefone"]');
        if (telefoneInputInicial) {
          aplicarMascaraTelefone(telefoneInputInicial);
        }

        // Formatar o nome em tempo real no campo inicial
        nomeInputInicial = document.querySelector('input[name="moradorNome"]');
        if (nomeInputInicial) {
          nomeInputInicial.addEventListener('input', function (e) {
...
window.adicionarMorador = function () {
  var moradoresDiv = document.getElementById('moradores');
  var novoMorador = document.createElement('div');
  ...
  var telefoneInput = novoMorador.querySelector('input[name="moradorTelefone"]');
  aplicarMascaraTelefone(telefoneInput);

  // Formatar o nome em tempo real
  var nomeInput = novoMorador.querySelector('input[name="moradorNome"]');
  nomeInput.addEventListener('input', function (e) {
    e.target.value = formatarNome(e.target.value);
  });
};
window.removerMorador = function (botao) {
  var moradorDiv = botao.parentElement;
  moradorDiv.remove();
};
...
document.getElementById('cadastroForm').addEventListener('submit', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
    var nomeCondominio, bloco, apartamento, moradores, moradoresDivs, telefoneValido, response, result;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          apartamento = document.getElementById('apartamento').value.trim(); // Validação de campos obrigatórios
        ...
        case 10:
          ...
          moradores = [];
          moradoresDivs = document.querySelectorAll('.morador');
        ...
        case 15:
          telefoneValido = true;
          moradoresDivs.forEach(function (morador) {
            var nome = formatarNome(morador.querySelector('input[name="moradorNome"]').value.trim());
            var telefoneComMascara = morador.querySelector('input[name="moradorTelefone"]').value.trim();
            var telefone = removerMascaraTelefone(telefoneComMascara); // Remove a máscara
        ...
        case 19:
          _context2.next = 21;
          return fetch('http://localhost:5000/api/apartamentos/cadastrar', {
            method: 'POST',
            headers: {
...
},{"vanilla-masker":"../node_modules/vanilla-masker/lib/vanilla-masker.js"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
